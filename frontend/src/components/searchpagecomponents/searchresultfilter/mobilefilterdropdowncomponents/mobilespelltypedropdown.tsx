...
export function MobileSpellTypeDropDownComponent({ spelldropdownprops }: spellDropDown ) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-[50vw] h-8 border-transparent text-[hsl(var(--text))] justify-between"
        >
      ...
      <PopoverContent className="w-[50vw] p-0 relative top-[-42px]">
        <Command>
          <CommandInput placeholder="Filter by Spell Types..." className="h-9" />
