                            ...
                            <div className="flex w-full h-[20vh] mb-2 bg-transparentt">
                                ...
                                <div className="flex h-[20vh] overflow-y-auto w-full min-h-full flex-col border-2 border-transparent hover:border-gray-500">
                                    <section className="relative flex justify-between w-full h-[20%]">
                                        <span className="flex text-center items-center pl-[3%] w-[60%] text-[hsl(var(--background3))] font-black text-xs lg:text-2xl">{card.name}</span>
                                        <div className="flex justify-between items-center lg:font-bold w-[40%]">
                                            <span className="text-[hsl(var(--text))] w-[40%] text-[10px] lg:text-xl">{card?.type}</span>
                                    ...
                                    <div className="flex flex-col h-[80%]">
                                        <section className={`flex-grow overflow-y-auto max-h-full px-[3%] pt-[5px]`}>
                                            <span className="text-xs lg:text-sm text-ellipsis text-[hsl(var(--text))] font-semibold lg:font-black">{card?.desc}</span>
                                        </section>
                                        {(card?.atk || card?.atk === 0 || card?.def || card?.def === 0 || card?.level || card?.scale || card?.linkval) && (     
                                            <section className="w-full h-fit flex space-x-2 lg:space-x-12 pl-[3%]">
                                                {(card?.atk || card?.atk === 0)&& (
                                                    <div className="flex font-bold text-xs lg:text-lg">
