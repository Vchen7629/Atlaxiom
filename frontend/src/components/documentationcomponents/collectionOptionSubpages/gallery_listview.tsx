...
export function GalleryListViewCollectionSubPage() {
    ...
    return (
        <main className="flex flex-col space-y-[3vh] w-full h-full">
            ...
            <div className="flex items-center space-x-2">
                <span className="text-xl text-white"> List View Active: </span>
                <div className='flex bg-footer rounded-lg'>
                    <span className="text-white p-1 px-2 rounded-xl mr-2 bg-[hsl(var(--background3))]">
            ...
            <div className="flex items-center space-x-2">
                <span className="text-xl text-white"> Gallery View Active: </span>
                <div className='flex bg-footer rounded-lg '>
