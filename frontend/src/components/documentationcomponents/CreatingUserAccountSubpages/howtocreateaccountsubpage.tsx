    ...
    return (
        ...
        <main className="flex flex-col space-y-[3vh] w-full h-full">
            ...
            <div className="flex flex-col space-y-[2vh] w-[80%]">
                <span className="text-3xl text-[hsl(var(--text))]">Creating Your Account ( For non google oauth users )</span>
            ...
            <div className="flex flex-col space-y-[2vh] w-[80%]">
                <span className="text-3xl text-[hsl(var(--text))]">Creating Your Account via Google Oauth</span>
                <span className="text-lg font-normal text-gray-400">New Users can create a user account using their google account via google oauth</span>
            </div>
        </main>
    )
}