...
const AtkFilterComponent = ({ atkfilterprops }: atkprops) => {
    ...
    }, [setListCurrentPage, setGalleryCurrentPage, setCanClearFilter, setCanClearFilter, setAtkLessThanEqual, setAtkEqual, setAtkGreaterThanEqual]);
    ...
    const handleInputChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setListCurrentPage(1)
        setGalleryCurrentPage(1)
    }, [setAtkEqual, setCanClearFilter, setListCurrentPage, setGalleryCurrentPage]);
