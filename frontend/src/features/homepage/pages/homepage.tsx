...
import { CardSearchInfoBoxComponent } from '../components/cardSearchInfoBox.tsx';
import { DeckInfoBoxComponent } from '@/features/homepage/components/deckInfoBox.tsx';
import { UserStatisticsInfoBoxComponent } from '../components/userStatisticsInfoBox.tsx';
  ...
  return (
    ...
    <main className="bg-gradient-to-r from-[hsl(var(--homepagegradient1))]  to-[hsl(var(--homepagegradient2))]">
      ...
      <div className="relative flex min-h-[70vh] h-fit w-full flex-col justify-center items-center">    
        <div className="flex">
          <div className="relative flex flex-col items-center w-full">
            ...
            <div className="absolute top-[25vh] flex justify-center items-center lg:flex-row w-full space-x-[2vw] h-fit">
      ...
      <div className="px-[3vw] flex flex-col bg-[hsl(var(--bentogridbackground))] space-y-[5vh] pt-[5vh]  min-h-[100vh] pb-[10vh] items-center">
        ...
        <div className='w-[90vw] lg:w-[75vw] flex flex-col space-y-[10vh] h-fit'>
          <CardSearchInfoBoxComponent/>
          <DeckInfoBoxComponent />
          <UserStatisticsInfoBoxComponent/>
        </div>
      </div>
      <Footer/>
    </main>
