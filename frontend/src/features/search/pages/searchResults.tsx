...
import { BreadcrumbSearchResult } from '../components/breadcrumb.tsx';
import { SearchUserId } from '../types/searchbarpagestypes.ts';
import { PriceChartComponent } from '@/features/search/components/pricechart.tsx';
import { useLocation } from 'react-router-dom';
import Footer from '@/shared/components/Footer.tsx';
import Header from '@/shared/components/header.tsx';
import { CardSet } from '@/features/search/types/searchresultcomptypes.ts';
import { useState } from 'react';
import { ComponentCardSetPopup } from '@/features/search/buttons/addcard.tsx';
