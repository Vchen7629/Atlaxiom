        ...
        <div className="flex flex-col space-y-2 w-full items-center">
            ...
            <div className="flex justify-between w-full mr-2">
                <div className="flex w-[30%]">
                    <button 
                        className={`${lessThanEqual ? "bg-[hsl(var(--background3))]" : "bg-[hsl(var(--atkdefcomponent))]"} h-7 px-2 rounded-tl-lg rounded-bl-lg`}
                    ...
                    <button 
                        className={`${greaterThanEqual ? "bg-[hsl(var(--background3))]" : "bg-[hsl(var(--atkdefcomponent))]"} h-7 px-2 rounded-tr-lg rounded-br-lg`} 
...
export default MobileInputFilter