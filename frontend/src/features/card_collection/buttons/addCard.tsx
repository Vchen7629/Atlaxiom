...
import AddCardPaginationComponent from "../components/addcardpagination";
import SelectedCardComponent from "../pages/selectedCard";
import { mappedCard } from "../types/buttontypes";
            ...
            <AlertDialogDescription className="flex flex-col w-full items-center justify-center pt-4">
                {selectedcard ? (
                    <div className="flex w-full">
                        <SelectedCardComponent cardName={cardName}/>
                    </div>
                ) : (
                    <>
