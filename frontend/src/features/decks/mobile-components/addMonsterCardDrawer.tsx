...
import { GalleryResult, Result } from "@/features/decks/types/sidebarComponents";
import MobileCollectionMonsterCardSearchBarComponent from "./collectionmonstercardsearchbar";
import { useGetOwnedCardsQuery } from "@/app/api-slices/ownedCardapislice";
import MobileCollectionMonsterCardDisplayComponent from "./collectionmonstercarddisplay";
import AllCardsMobileSearchBarComponent from "./allcardsmonstercardsearchbar";
import MobileAllCardsMonsterCardDisplayComponent from "./allcardsmonstercarddisplay";
