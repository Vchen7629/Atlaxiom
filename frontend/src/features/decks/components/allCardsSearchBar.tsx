...
import { AllCardsSearchbarCompProps } from "../types/searchBar.ts";


const AllCardsSearchBar = ({ AllCardsSearchBarCompProps }: AllCardsSearchbarCompProps ) => {
    const {
...
export default AllCardsSearchBar