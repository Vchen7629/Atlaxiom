...
const FilterResults = () => {
    ...
    return (
        <div className="w-full flex justify-end items-center ">
            <button className="w-[9%] bg-goldenrod h-24 rounded-tl-3xl rounded-bl-3xl"><CaretRightIcon className="h-10 w-10 text-footer"/></button>
            <div className="flex h-full w-[91%] flex-col bg-[#0e0d0d] rounded-2xl border-4 border-footer pt-[25%]">
